 ...
 */
public class ChargeCrafterScreen extends AbstractContainerScreen<ChargeCrafterMenu>
{

    private final ResourceLocation GUI = new ResourceLocation(InterviewMod.ID, "textures/gui/charge_gui.png");

    public ChargeCrafterScreen(ChargeCrafterMenu container, Inventory inv, Component name) {
